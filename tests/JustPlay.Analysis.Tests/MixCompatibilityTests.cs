...
public class MixCompatibilityTests
{
    ...
    public void ClashingKeyVeryDifferentTempo_LowScore()
    {
        ...
        //   r=0.5 -> 0.5x320=160, |1-128/160| = 0.20 -> ZeroBand boundary -> Tempo = 0.0.
        // Energy: 5 vs 1 -> |delta|=4 -> 1-4/9 ~ 0.556.
    ...
    public void ThreeHalvesTempo_TempoSubScoreIsHigh()
    {
        ...
        // (The ratio candidates are applied to bpmB: ratio x bpmB; 1.5 x 100 = 150.)
    ...
    {
        // 128 vs 80: check all candidate ratios r x 80:
        ...
        // 1.5 x 85 = 127.5 ~ 128 - this pair is beatmatchable via the 3:2 feel.
        //
        ...
        // A clearer zero-zone pair: bpmB = 320 (well above anything usable even at 0.5x).
