...
/// Pink noise has power spectral density ∝ 1/f, giving equal energy per octave.  In a
...
/// guidance, Toole "Sound Reproduction" §11, Theile equal-energy reference).  The practical
...
public static class SpectralTarget
{
    ...
    ///   <item>f &gt; 120 Hz: returns <c>−3 · log₂(f / 1000)</c> — the equal-energy roll-off.</item>
    /// </list>
