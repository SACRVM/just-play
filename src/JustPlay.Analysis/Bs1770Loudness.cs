...
/// was chosen to satisfy this; 48 kHz uses −0.691. [energy-detection.md §44.1 kHz GOTCHA]</para>
///
/// <para>Platform-agnostic, reflection-free, trim/AOT-safe.</para>
/// </summary>
internal static class Bs1770Loudness
{
    // ---- BS.1770 loudness block parameters [energy-detection.md §gated integration] ----
