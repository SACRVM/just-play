...
/// <summary>
/// Tiny themed single-line text-input dialog. <see cref="AskAsync"/> shows it modally over an owner
/// window and returns the trimmed entry, or null if the user cancels / leaves it empty. Enter confirms,
/// Esc cancels.
/// </summary>
