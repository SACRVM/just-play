...
public sealed class FinderEntryViewModel
{
    ...
    /// <summary>Norton-Commander glyphs: ".." and real folders carry the folder icon; a playlist
    /// gets the list icon (Chloe 2026-07-05: "ordner symbol + ein listen symbol für playlist").</summary>
    public string Glyph => Kind == FinderEntryKind.Playlist ? "☰" : "📁";
