...
public sealed record AnalysisResult
{
    ...
    /// See <c>references/beatgrid-confidence.md Sec.3.4</c>.
    /// </summary>
    ...
    /// Recipe: 0.40 x FourOnFloor + 0.25 x AcfSharpness + 0.20 x (1-HalfTimeFeel)
    ///         + 0.15 x (1-min(Syncopationx2, 1)).
    /// (!) GRID_SOFT_WARN threshold = 0.45; GRID_HARD_FAIL = 0.25.
    /// Null when RhythmPattern or AcfSharpness has not been computed.
    /// See <c>references/beatgrid-confidence.md Sec.3.2-3.3</c>.
    /// </summary>
